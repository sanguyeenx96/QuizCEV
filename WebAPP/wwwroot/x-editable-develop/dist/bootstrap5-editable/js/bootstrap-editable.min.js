...
!(function (a) {
    ...
    (b.prototype = {
        ...
        error: function (b) {
            var e,
                f,
                c = this.$form.find(".control-group"),
                d = this.$form.find(".editable-error-block");
            if (b === !1)
                c.removeClass(a.fn.editableform.errorGroupClass),
                    d
                ...
                if (b) {
                    for (e = ("" + b).split("\n"), f = 0; f < e.length; f++)
                        e[f] = a("<div>").text(e[f]).html();
                    b = e.join("<br>");
                }
                c.addClass(a.fn.editableform.errorGroupClass),
                    d
        ...
        submit: function (b) {
            ...
            if (
                (b.stopPropagation(),
                b.preventDefault(),
                (c = this.input.input2value()),
                (d = this.validate(c)),
                "object" === a.type(d) && void 0 !== d.newValue)
            ) {
                if (
                    ((c = d.newValue),
            ...
            return this.options.savenochange ||
                this.input.value2str(c) !== this.input.value2str(this.value)
                ? ((e = this.input.value2submit(c)),
                  (this.isSaving = !0),
                  a
                      .when(this.save(e))
                      .done(
                  ...
                  void 0)
                : (this.$div.triggerHandler("nochange"), void 0);
        },
        save: function (b) {
            ...
            return d
                ? (this.showLoading(),
                  (e = { name: this.options.name || "", value: b, pk: c }),
                  "function" === typeof this.options.params
                      ? (e = this.options.params.call(this.options.scope, e))
                      : ((this.options.params = a.fn.editableutils.tryParseJson(
                            this.options.params,
                            !0
                        )),
                        a.extend(e, this.options.params)),
                  "function" === typeof this.options.url
                      ? this.options.url.call(this.options.scope, e)
                      : a.ajax(
                            a.extend(
                                {
    ...
    (function (a) {
        ...
        a.fn.editableutils = {
            ...
            supportsTransitions: function () {
                ...
                for (
                    c = c.charAt(0).toUpperCase() + c.substr(1), e = 0;
                    e < d.length;
                    e++
                )
                        ...
                        a(document).on("click.editable", function (c) {
                            ...
                            if (
                                ...
                                for (e = 0; e < f.length; e++)
                                    if (d.is(f[e]) || d.parents(f[e]).length)
                                        return;
                ...
                onSourceReady: function (b, c) {
                    ...
                    if ("string" === typeof d) {
                        if (this.options.sourceCache) {
                            if (
                                ((f = d),
                                a(document).data(f) || a(document).data(f, {}),
                                (g = a(document).data(f)),
                                g.loading === !1 && g.sourceData)
                            )
                                return (
                                    (this.sourceData = g.sourceData),
                                    this.doPrepend(),
                                    b.call(this),
                                    void 0
                                );
                            if (g.loading === !0)
                                return (
                                    ...
                                    g.err_callbacks.push(a.proxy(c, this)),
                                    void 0
                                );
                            (g.loading = !0),
                                (g.callbacks = []),
                                ...
                                "object" === typeof f
                                    ? ((c = 0),
                                      ...
                                      1 === c
                                          ...
                                          : c > 1 &&
                                            (f.children &&
                                                (f.children = this.makeArray(
                                                    f.children
                                                )),
                                            e.push(f)))
                                    : e.push({ value: f, text: f });
                    else
                        a.each(b, function (a, b) {
                            e.push({ value: a, text: b });
                        });
                    return e;
                },
                option: function (a, b) {
            ...
            a.extend(b.prototype, {
                renderList: function () {
                    ...
                    if ((this.$tpl.empty(), a.isArray(this.sourceData))) {
                        for (d = 0; d < this.sourceData.length; d++)
                            (b = a("<label>").append(
                                a("<input>", {
                                    type: "checkbox",
                                    value: this.sourceData[d].value,
                                })
                            )),
                                (e = a("<span>")),
                                e[this.options.escape ? "text" : "html"](
                                    " " + this.sourceData[d].text
                                ),
                                b.append(e),
            ...
            a.extend(b.prototype, {
                ...
                value2html: function (c, d) {
                    ...
                    this.options.select2.tags
                        ? (f = c)
                        : this.sourceData &&
                          (f = a.fn.editableutils.itemsByValue(
                              c,
                              this.sourceData,
                              this.idFunc
                          )),
                        a.isArray(f)
                            ...
                            : f && (e = g.formatSelection(f)),
                        (e = a.isArray(e)
                            ? e.join(this.options.viewseparator)
                            : e),
                ...
                value2input: function (b) {
                    ...
                    a.isArray(b) && (b = b.join(this.getSeparator())),
                        ...
                        !this.isRemote ||
                            ...
                            ((c = this.options.select2.id),
                            (d = this.options.select2.formatSelection),
                            c ||
                                d ||
                                ((e = a(this.options.scope)),
                                e.data("editable").isEmpty ||
                                    ((f = { id: b, text: e.text() }),
    ...
    (function (a) {
        ...
        (b.prototype = {
            ...
            fillDay: function () {
                ...
                for (
                    this.options.smartDays &&
                        this.$month &&
                        this.$year &&
                        ((f = parseInt(this.$month.val(), 10)),
                        (g = parseInt(this.$year.val(), 10)),
                        isNaN(f) ||
                            isNaN(g) ||
                            (e = moment([g, f]).daysInMonth())),
                        c = 1;
                    e >= c;
                    c++
                )
                    (b = d ? this.leadZero(c) : c), a.push([c, b]);
                return a;
            },
            fillMonth: function () {
                var b,
                ...
                for (c = 0; 11 >= c; c++)
                    (b = d
                        ? moment().date(1).month(c).format("MM - MMMM")
                        : e
                        ? moment().date(1).month(c).format("MM - MMM")
                        : f
                        ? moment().date(1).month(c).format("MMMM")
                        : g
                        ? moment().date(1).month(c).format("MMM")
                        : h
                        ? this.leadZero(c + 1)
                        : c + 1),
                        a.push([c, b]);
            ...
            fillYear: function () {
                ...
                for (c = this.options.maxYear; c >= this.options.minYear; c--)
                    (b = d ? c : (c + "").substring(2)),
                        a[this.options.yearDescending ? "push" : "unshift"]([
                            c,
                            b,
                        ]);
                return (a = this.fillCommon("y").concat(a));
            },
            fillHour: function () {
                var b,
                    c,
                    ...
                    h = d ? 12 : 23;
                for (c = g; h >= c; c++)
                    (b = f ? this.leadZero(c) : c), a.push([c, b]);
                return a;
            },
            fillMinute: function () {
                var b,
                ...
                for (c = 0; 59 >= c; c += this.options.minuteStep)
                    (b = d ? this.leadZero(c) : c), a.push([c, b]);
                return a;
            },
            fillSecond: function () {
                ...
                for (c = 0; 59 >= c; c += this.options.secondStep)
                    (b = d ? this.leadZero(c) : c), a.push([c, b]);
                return a;
            },
            fillAmpm: function () {
    ...
    (function (a) {
        ...
        a.extend(a.fn.editableform.Constructor.prototype, {
            ...
            initInput: function () {
                ...
                for (
                    b.apply(this),
                        ...
                        f = this.$form.find(".editable-buttons"),
            ...
            (a.fn.editableform.buttons =
                '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="bi-check" aria-hidden="true"></i></button><button type="button" class="btn btn-secondary btn-sm editable-cancel"><i class="bi-x" aria-hidden="true"></i></button>'),
        ...
        (d.prototype = {
            ...
            _process_options: function (b) {
                ...
                switch (
                    ...
                    (c = this.o = a.extend({}, this._o)),
                    (d = c.language),
                    l[d] || ((d = d.split("-")[0]), l[d] || (d = j.language)),
                    (c.language = d),
                    c.startView)
                ) {
                    case 2:
                ...
                (c.startView = Math.max(c.startView, c.minViewMode)),
                    ...
                    (e = m.parseFormat(c.format)),
                    c.startDate !== -1 / 0 &&
                        (c.startDate = m.parseDate(c.startDate, e, c.language)),
                    1 / 0 !== c.endDate &&
                        (c.endDate = m.parseDate(c.endDate, e, c.language)),
            ...
            _trigger: function (b, c) {
                ...
                this.element.trigger({
                    ...
                    format: a.proxy(function (a) {
                        ...
                        return m.formatDate(d, b, this.o.language);
                    }, this),
                });
            },
            show: function (a) {
            ...
            getFormattedDate: function (a) {
                return (
                    ...
                    m.formatDate(this.date, a, this.o.language)
                );
            },
            ...
            fillMonths: function () {
                for (var a = "", b = 0; 12 > b; )
                    a +=
                        '<span class="month">' +
                        l[this.o.language].monthsShort[b++] +
                        "</span>";
            ...
            fill: function () {
                ...
                for (
                    this.date && this.date.valueOf(),
                        this.picker
                            ...
                            .text(l[this.o.language].months[e] + " " + d),
                        this.picker
                            .find("tfoot th.today")
                            .text(l[this.o.language].today)
                            .toggle(this.o.todayBtn !== !1),
                        this.picker
                            .find("tfoot th.clear")
                            .text(l[this.o.language].clear)
                            .toggle(this.o.clearBtn !== !1),
                        this.updateNavArrows(),
                        this.fillMonths(),
                        n = b(d, e - 1, 28, 0, 0, 0, 0),
                        o = m.getDaysInMonth(
                            n.getUTCFullYear(),
                            n.getUTCMonth()
                        ),
                    ...
                    n.getUTCDay() == this.o.weekStart &&
                        ...
                        this.o.calendarWeeks &&
                            ...
                            (t = new Date(
                                +s + 864e5 * ((11 - s.getUTCDay()) % 7)
                            )),
                            (u = new Date(
                                +(u = b(t.getUTCFullYear(), 0, 1)) +
                                    864e5 * ((11 - u.getUTCDay()) % 7)
                            )),
                            (v = (t - u) / 864e5 / 7 + 1),
                            q.push('<td class="cw">' + v + "</td>"))),
                        (r = this.getClassNames(n)),
                        r.push("day"),
                        (w = this.o.beforeShowDay(n)),
                        void 0 === w
                            ? (w = {})
                            : "boolean" === typeof w
                            ? (w = { enabled: w })
                            : "string" === typeof w && (w = { classes: w }),
                        w.enabled === !1 && r.push("disabled"),
                        w.classes && (r = r.concat(w.classes.split(/\s+/))),
                        w.tooltip && (k = w.tooltip),
                        (r = a.unique(r)),
                        q.push(
                            '<td class="' +
                                r.join(" ") +
                        ...
                        n.getUTCDay() == this.o.weekEnd && q.push("</tr>"),
                ...
                for (
                    this.picker
                        ...
                        .empty()
                        .append(q.join("")),
                        x = this.date && this.date.getUTCFullYear(),
                        y = this.picker
                        ...
                        x &&
                            x == d &&
                            y.eq(this.date.getUTCMonth()).addClass("active"),
                        (f > d || d > h) && y.addClass("disabled"),
                        d == f && y.slice(0, g).addClass("disabled"),
                        d == h && y.slice(i + 1).addClass("disabled"),
                        q = "",
                        d = 10 * parseInt(d / 10, 10),
                        z = this.picker
            ...
            click: function (c) {
                ...
                if (
                    (c.preventDefault(),
                    (d = a(c.target).closest("span, td, th")),
                    1 == d.length)
                )
            ...
            moveMonth: function (a, b) {
                ...
                if (
                    ...
                    for (i = 0; f > i; i++) c = this.moveMonth(c, b);
                    (g = c.getUTCMonth()),
                        c.setUTCDate(d),
                        (h = function () {
                ...
                for (; h(); ) c.setUTCDate(--d), c.setUTCMonth(g);
                return c;
            },
            ...
            keydown: function (a) {
                ...
                switch (((b = !1), a.keyCode)) {
                    ...
                    case 39:
                        ...
                        (c = 37 == a.keyCode ? -1 : 1),
                            a.ctrlKey
                                ? ((f = this.moveYear(this.date, c)),
                                  (g = this.moveYear(this.viewDate, c)))
                                : a.shiftKey
                                ? ((f = this.moveMonth(this.date, c)),
                                  (g = this.moveMonth(this.viewDate, c)))
                                : ((f = new Date(this.date)),
                                  f.setUTCDate(this.date.getUTCDate() + c),
                                  (g = new Date(this.viewDate)),
                                  g.setUTCDate(this.viewDate.getUTCDate() + c)),
                            this.dateWithinRange(f) &&
                                ((this.date = f),
                                (this.viewDate = g),
                                this.setValue(),
                                this.update(),
                        ...
                        (c = 38 == a.keyCode ? -1 : 1),
                            a.ctrlKey
                                ...
                                ? ((f = this.moveMonth(this.date, c)),
                                  (g = this.moveMonth(this.viewDate, c)))
                                : ((f = new Date(this.date)),
                                  f.setUTCDate(this.date.getUTCDate() + 7 * c),
                                  (g = new Date(this.viewDate)),
                                  g.setUTCDate(
                                      this.viewDate.getUTCDate() + 7 * c
                                  )),
                            this.dateWithinRange(f) &&
                                ((this.date = f),
                                (this.viewDate = g),
                        ...
                        this.each(function () {
                            ...
                            return (
                                k ||
                                    ...
                                    (o = g(n.language)),
                                    (p = a.extend({}, j, o, m, l)),
                                    i.is(".input-daterange") || p.inputs
                                        ? ((q = {
                                              inputs:
                                                  p.inputs ||
                                                  i.find("input").toArray(),
                                          }),
                                          i.data(
                                              "datepicker",
                                              (k = new e(this, a.extend(p, q)))
                                          ))
                                        : i.data(
                                              "datepicker",
                                              (k = new d(this, p))
            ...
            (k = a.fn.datepicker.locale_opts = ["format", "rtl", "weekStart"]),
            (a.fn.datepicker.Constructor = d),
            (l = a.fn.datepicker.dates =
                {
                    en: {
                        days: [
                            "Sunday",
            ...
            (m = {
                ...
                parseDate: function (c, e, f) {
                    ...
                    if (
                        ...
                        for (
                            ...
                            switch (
                                ((i = g.exec(h[k])), (j = parseInt(i[1])), i[2])
                            ) {
                                case "d":
                                    c.setUTCDate(c.getUTCDate() + j);
                                    break;
                                case "m":
                                    c = d.prototype.moveMonth.call(
                                        d.prototype,
                                        c,
                                        j
                                    );
                    ...
                    if (
                        ((h = (c && c.match(this.nonpunctuation)) || []),
                        (c = new Date()),
                        (n = {}),
                        (o = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"]),
                        (p = {
                            yyyy: function (a, b) {
                        ...
                        h.length != s.length &&
                            (s = a(s)
                                .filter(function (b, c) {
                                    return -1 !== a.inArray(c, o);
                                })
                                .toArray()),
                        h.length == s.length)
                    ) {
                        for (k = 0, t = s.length; t > k; k++) {
                            if (
                                ((q = parseInt(h[k], 10)), (i = s[k]), isNaN(q))
                            )
                                switch (i) {
                                    case "MM":
                                        (r = a(l[f].months).filter(function () {
                                            var a = this.slice(0, h[k].length),
                                                b = h[k].slice(0, a.length);
                                            return a == b;
                                        })),
                                            (q =
                                                a.inArray(r[0], l[f].months) +
                                                1);
                                        break;
                                    case "M":
                                        (r = a(l[f].monthsShort).filter(
                                            function () {
                                                var a = this.slice(
                                                        0,
                                                        h[k].length
                        ...
                        for (k = 0; k < o.length; k++)
                            (u = o[k]), u in n && !isNaN(n[u]) && p[u](c, n[u]);
                    }
                    return c;
                },
                formatDate: function (b, c, d) {
                    var e, f, g, h;
                    for (
                        "string" === typeof c && (c = m.parseFormat(c)),
                            e = {
                                d: b.getUTCDate(),
                                D: l[d].daysShort[b.getUTCDay()],
                                DD: l[d].days[b.getUTCDay()],
                                m: b.getUTCMonth() + 1,
                                M: l[d].monthsShort[b.getUTCMonth()],
                                MM: l[d].months[b.getUTCMonth()],
            ...
            a(document).on(
                ...
                function (b) {
                    var c = a(this);
                    c.data("datepicker") ||
                        (b.preventDefault(), i.call(c, "show"));
                }
            ),
            a(function () {
                i.call(a('[data-provide="datepicker-inline"]'));
            });
    })(window.jQuery),
    (function (a) {
        "use strict";
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            a.extend(b.prototype, {
                ...
                parseDate: function (a, b) {
                    ...
                    return (
                        a &&
                            ((c = this.dpg.parseDate(
                                a,
                                b,
                                this.options.datepicker.language
                            )),
                            "string" === typeof a &&
                                ((d = this.dpg.formatDate(
                                    c,
                                    b,
                                    this.options.datepicker.language
                                )),
