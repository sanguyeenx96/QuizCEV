...
namespace Data.Migrations
{
    ...
    [Migration("20240123082432_AddReadsTable")]
    partial class AddReadsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "833ec544-6c35-434f-b616-9e7653911fc9",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2f83b0b9-7248-4f10-93a7-d5ba10564aea",
            ...
            modelBuilder.Entity("Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CellId = 1,
                            ConcurrencyStamp = "87e302cc-0536-4943-a470-ea8305df86c6",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGkkCfTEPF3DC3JNYJtw9dVt89m368ktfO/cMEMXFTJhNy+XMOhrKyzSyVkx37kOMA==",
            ...
            modelBuilder.Entity("Data.Entities.ReadCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReadCategory", (string)null);
                });

            modelBuilder.Entity("Data.Entities.ReadPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReadCategoryId");

                    b.ToTable("ReadPost", (string)null);
                });

            modelBuilder.Entity("Data.Entities.ReadResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReadPostId");

                    b.HasIndex("UserId");

                    b.ToTable("ReadResult", (string)null);
                });
            ...
            modelBuilder.Entity("Data.Entities.PostPost", b =>
                {
                    b.HasOne("Data.Entities.PostCategory", "postCategory")
                        .WithMany("PostPosts")
            ...
            modelBuilder.Entity("Data.Entities.ReadPost", b =>
                {
                    b.HasOne("Data.Entities.ReadCategory", "readCategory")
                        .WithMany("readPosts")
                        .HasForeignKey("ReadCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("readCategory");
                });

            modelBuilder.Entity("Data.Entities.ReadResult", b =>
                {
                    b.HasOne("Data.Entities.ReadPost", "ReadPost")
                        .WithMany("readResults")
                        .HasForeignKey("ReadPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
